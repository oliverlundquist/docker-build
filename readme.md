...
docker buildx inspect --bootstrap (if builder is already created, run "docker buildx use builder" then use this command to start it if stopped, switch back by running "docker buildx use desktop-linux")
```
